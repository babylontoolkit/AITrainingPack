...
namespace PROJECT
{
    public static class AI_TrainingPackage
    {
        ...
        static bool AI_ValidateTrainScriptComponent()
        {
            ...
            if (path.IndexOf("AI_CodeTranslator", System.StringComparison.OrdinalIgnoreCase) > 0) return false;
            ...
            if (path.IndexOf("AI_TrainingPackage", System.StringComparison.OrdinalIgnoreCase) > 0) return false;
